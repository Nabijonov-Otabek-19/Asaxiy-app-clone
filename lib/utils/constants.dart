...
var categoryBolimlar = [
  ...
  MenuModel(2, "assets/images/ic_phone.png", white, 0, "Telefonlar va gadjetlar"),
  MenuModel(3, "assets/images/ic_wash_machine.png", white, 0, "Maishiy texnika"),
  MenuModel(4, "assets/images/ic_conditioner.png", white, 0, "Iqlim texnikasi"),
  MenuModel(5, "assets/images/ic_computer.png", white, 0, "Kompyuter texnikasi"),
  MenuModel(6, "assets/images/ic_sport.png", white, 0, "Sport va dam olish"),
  MenuModel(7, "assets/images/ic_ladder.png", white, 0, "Uy va ofis uchun tovarlar"),
  MenuModel(8, "assets/images/ic_tv.png", white, 0, "Televizor, video va audio"),
  MenuModel(9, "assets/images/ic_joystick.png", white, 0, "Geymerlar uchun tovarlar"),
  MenuModel(10, "assets/images/ic_sofa.png", white, 0, "Mebel"),
  MenuModel(11, "assets/images/ic_pan.png", white, 0, "Idish-tovoqlar"),
  MenuModel(12, "assets/images/ic_parfume.png", white, 0, "Go'zallik va salomatlik"),
  MenuModel(13, "assets/images/ic_bear.png", white, 0, "Bolalar uchun tovarlar"),
  MenuModel(14, "assets/images/ic_tshirt.png", white, 0, "Kiyim, poyabzal va aksessuarlar"),
  MenuModel(15, "assets/images/ic_gift.png", white, 0, "O'yinchoqlar, sovg'alar va aksessuarlar"),
